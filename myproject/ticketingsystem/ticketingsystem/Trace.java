...
public class Trace {
	...
	final static int retpc = 100; // return ticket operation is 10% percent
	final static int buypc = 300; // buy ticket operation is 30% percent
	final static int inqpc = 600; //inquiry ticket operation is 60% percent
	...
	for (int i = 0; i< threadnum; i++) {
	    	threads[i] = new Thread(new Runnable() {
                public void run() {
            		...
            		//System.out.prin tln(ThreadId.get());
